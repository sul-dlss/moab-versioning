...
- <b>1.3.3</b> Fix new Moab::UtcTime class to output of String when datetime value is nil or empty
- <b>1.4.0</b> Updates for ruby 2.x and related gems, see details at https://github.com/sul-dlss/moab-versioning/issues/3
- <b>1.4.1</b> Ensure xml output has UTF-8 encodings
- <b>1.4.3</b> Tidy rspec tests; confirm specs passing after bundle update
- <b>1.4.4</b> Fixed == methods to allow comparison with objects of differing classes without exceptions
- <b>1.5.0</b> Removed monkeypatches which were incompatible with Devise 3
