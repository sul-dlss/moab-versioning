  ...
  describe '#validation_errors' do
    ...
    describe 'invalid_moab' do
      ...
      context 'under data directory' do
        ...
        context 'content directory' do
          ...
          context 'allow_content_subdirs argument' do
            ...
            context 'forbidden subdirectories' do
      ...
      context 'does not call #check_expected_data_sub_dirs' do
        ...
        it 'moab does not have the expected version sub dirs' do
