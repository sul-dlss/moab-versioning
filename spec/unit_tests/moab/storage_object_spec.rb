...
describe 'Moab::StorageObject' do
  ...
  describe '=========================== INSTANCE METHODS ===========================' do
    ...
    specify 'Moab::StorageObject#versionize_bag' do
      ...
      new_inventory.to_xml.gsub(/datetime=".*"/, 'datetime=""').gsub(/inventoryDatetime=".*?"/,'').
      ...
      bag_dir.join('versionAdditions.xml').read.gsub(/datetime=".*"/, 'datetime=""').gsub(/inventoryDatetime=".*?"/,'').should be_equivalent_to(<<-EOF
