...
describe 'Moab::FileGroupDifference' do
  ...
  describe '=========================== CONSTRUCTOR ===========================' do
    ...
    specify 'Moab::FileGroupDifference#initialize' do
      ...
      expect(file_group_difference).to be_instance_of(FileGroupDifference)
  ...
  describe '=========================== INSTANCE METHODS ===========================' do
    ...
    specify 'Moab::FileGroupDifference#summary' do
      ...
      expect(summary).to be_instance_of(FileGroupDifference)
      summary.group_id = ''
    ...
    # * basis_signature_hash [Hash<FileSignature, FileManifestation>] = Signature to file path mapping from the file group that is the basis of the comparison
    # * other_signature_hash [Hash<FileSignature, FileManifestation>] = Signature to file path mapping from the file group that is the being compared to the basis group
    specify 'Moab::FileGroupDifference#tabulate_unchanged_files' do
      ...
      expect(unchanged_subset).to be_instance_of(FileGroupDifferenceSubset)
      ...
      expect(file0.signatures[0].fixity).to eq({:size=>"40873", :md5=> "1a726cd7963bd6d3ceb10a8c353ec166", :sha1=> "583220e0572640abcd3ddd97393d224e8053a6ad", :sha256=>"8b0cee693a3cf93cf85220dd67c5dc017a7edcdb59cde8fa7b7f697be162b0c5"})
    ...
    specify 'Moab::FileGroupDifference#tabulate_renamed_files' do
      ...
      expect(renamed_subset).to be_instance_of(FileGroupDifferenceSubset)
      ...
      expect(file0.signatures[0].fixity).to eq({:size=>"39450", :md5=>"82fc107c88446a3119a51a8663d1e955", :sha1=>"d0857baa307a2e9efff42467b5abd4e1cf40fcd5", :sha256=>"235de16df4804858aefb7690baf593fb572d64bb6875ec522a4eea1f4189b5f0"})
      ...
      expect(file1.signatures[0].fixity).to eq({:size=>"19125", :md5=>"a5099878de7e2e064432d6df44ca8827", :sha1=>"c0ccac433cf02a6cee89c14f9ba6072a184447a2", :sha256=>"7bd120459eff0ecd21df94271e5c14771bfca5137d1dd74117b6a37123dfe271"})
    ...
    # For input parameters:
    # * basis_path_hash [Hash<String,FileSignature>] = The file paths and associated signatures for manifestations appearing only in the basis group
    # * other_path_hash [Hash<String,FileSignature>] = The file paths and associated signatures for manifestations appearing only in the other group
    specify 'Moab::FileGroupDifference#tabulate_modified_files' do
      ...
      expect(modified_subset).to be_instance_of(FileGroupDifferenceSubset)
      ...
      expect(file0.other_path).to eq('same')
      expect(file0.signatures[0].fixity).to eq({:size=>"25153", :md5=>"3dee12fb4f1c28351c7482b76ff76ae4", :sha1=>"906c1314f3ab344563acbbbe2c7930f08429e35b", :sha256=>"41aaf8598c9d8e3ee5d55efb9be11c542099d9f994b5935995d0abea231b8bad"})
    ...
    specify 'Moab::FileGroupDifference#tabulate_deleted_files' do
      ...
      expect(deleted_subset).to be_instance_of(FileGroupDifferenceSubset)
      ...
      expect(file0.signatures[0].fixity).to eq({:size=>"41981", :md5=>"915c0305bf50c55143f1506295dc122c", :sha1=>"60448956fbe069979fce6a6e55dba4ce1f915178", :sha256=>"4943c6ffdea7e33b74fd7918de900de60e9073148302b0ad1bf5df0e6cec032a"})
      ...
      expect(file1.signatures[0].fixity).to eq({:size=>"39850", :md5=>"77f1a4efdcea6a476505df9b9fba82a7", :sha1=>"a49ae3f3771d99ceea13ec825c9c2b73fc1a9915", :sha256=>"3a28718a8867e4329cd0363a84aee1c614d0f11229a82e87c6c5072a6e1b15e7"})
    ...
    specify 'Moab::FileGroupDifference#tabulate_added_files' do
      ...
      expect(added_subset).to be_instance_of(FileGroupDifferenceSubset)
      ...
      expect(file0.signatures[0].fixity).to eq({:size=>"39539", :md5=>"fe6e3ffa1b02ced189db640f68da0cc2", :sha1=>"43ced73681687bc8e6f483618f0dcff7665e0ba7", :sha256=>"42c0cd1fe06615d8fdb8c2e3400d6fe38461310b4ecc252e1774e0c9e3981afa"})
