...
describe 'Stanford::ContentInventory' do
  ...
  describe '=========================== INSTANCE METHODS ===========================' do
    ...
    # Which returns: [FileGroup] The {FileGroup} object generated from a ContentInventory instance
    # For input parameters:
    # * content_metadata [String] = The ContentInventory as a string
    specify 'Stanford::ContentInventory#group_from_cm' do
      ...
      #   content_group = FileGroup.new(:group_id=>'content', :data_source => 'ContentInventory')
    ...
    # Which returns: [String] The ContentInventory instance generated from the FileGroup
    # For input parameters:
...
EOF
      ...
      #     xml.ContentInventory(:type=>"sample", :objectId=>@digital_object_id) {
